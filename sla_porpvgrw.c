...
extern VOID sla_porpvgrw_(real *__out__, char *uplo, integer *ncols, real *a, integer *lda, real *af, integer *ldaf, real *work);
static VALUE
rb_sla_porpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  sla_porpvgrw_(&__out__, &uplo, &ncols, a, &lda, af, &ldaf, work);
