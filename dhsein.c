...
rb_dhsein(int argc, VALUE *argv, VALUE self){
  ...
  if (NA_SHAPE0(rb_wr) != n)
    rb_raise(rb_eRuntimeError, "shape 0 of wr must be the same as shape 0 of select");
  ...
  if (NA_SHAPE0(rb_wi) != n)
    rb_raise(rb_eRuntimeError, "shape 0 of wi must be the same as shape 0 of select");
