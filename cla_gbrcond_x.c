...
extern VOID cla_gbrcond_x_(real *__out__, char *trans, integer *n, integer *kl, integer *ku, complex *ab, integer *ldab, complex *afb, integer *ldafb, integer *ipiv, complex *x, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_gbrcond_x(int argc, VALUE *argv, VALUE self){
  ...
  cla_gbrcond_x_(&__out__, &trans, &n, &kl, &ku, ab, &ldab, afb, &ldafb, ipiv, x, &info, work, rwork);
