...
extern VOID zla_porpvgrw_(doublereal *__out__, char *uplo, integer *ncols, doublecomplex *a, integer *lda, doublecomplex *af, integer *ldaf, doublecomplex *work);
static VALUE
rb_zla_porpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  zla_porpvgrw_(&__out__, &uplo, &ncols, a, &lda, af, &ldaf, work);
