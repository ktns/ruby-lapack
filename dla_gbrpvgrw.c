...
extern VOID dla_gbrpvgrw_(doublereal *__out__, integer *n, integer *kl, integer *ku, integer *ncols, doublereal *ab, integer *ldab, doublereal *afb, integer *ldafb);
static VALUE
rb_dla_gbrpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  dla_gbrpvgrw_(&__out__, &n, &kl, &ku, &ncols, ab, &ldab, afb, &ldafb);
