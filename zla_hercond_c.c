...
extern VOID zla_hercond_c_(doublereal *__out__, char *uplo, integer *n, doublecomplex *a, integer *lda, doublecomplex *af, integer *ldaf, integer *ipiv, doublereal *c, logical *capply, integer *info, doublecomplex *work, doublereal *rwork);
static VALUE
rb_zla_hercond_c(int argc, VALUE *argv, VALUE self){
  ...
  zla_hercond_c_(&__out__, &uplo, &n, a, &lda, af, &ldaf, ipiv, c, &capply, &info, work, rwork);
