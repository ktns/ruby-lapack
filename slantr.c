...
extern VOID slantr_(real *__out__, char *norm, char *uplo, char *diag, integer *m, integer *n, real *a, integer *lda, real *work);
static VALUE
rb_slantr(int argc, VALUE *argv, VALUE self){
  ...
  slantr_(&__out__, &norm, &uplo, &diag, &m, &n, a, &lda, work);
