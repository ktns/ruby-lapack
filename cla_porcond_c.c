...
extern VOID cla_porcond_c_(real *__out__, char *uplo, integer *n, complex *a, integer *lda, complex *af, integer *ldaf, real *c, logical *capply, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_porcond_c(int argc, VALUE *argv, VALUE self){
  ...
  cla_porcond_c_(&__out__, &uplo, &n, a, &lda, af, &ldaf, c, &capply, &info, work, rwork);
