...
extern VOID sla_syrpvgrw_(real *__out__, char *uplo, integer *n, integer *info, real *a, integer *lda, real *af, integer *ldaf, integer *ipiv, real *work);
static VALUE
rb_sla_syrpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  sla_syrpvgrw_(&__out__, &uplo, &n, &info, a, &lda, af, &ldaf, ipiv, work);
