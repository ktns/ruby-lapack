...
extern VOID zla_gbrpvgrw_(doublereal *__out__, integer *n, integer *kl, integer *ku, integer *ncols, doublecomplex *ab, integer *ldab, doublecomplex *afb, integer *ldafb);
static VALUE
rb_zla_gbrpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  zla_gbrpvgrw_(&__out__, &n, &kl, &ku, &ncols, ab, &ldab, afb, &ldafb);
