...
extern VOID cla_gercond_c_(real *__out__, char *trans, integer *n, complex *a, integer *lda, complex *af, integer *ldaf, integer *ipiv, real *c, logical *capply, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_gercond_c(int argc, VALUE *argv, VALUE self){
  ...
  cla_gercond_c_(&__out__, &trans, &n, a, &lda, af, &ldaf, ipiv, c, &capply, &info, work, rwork);
