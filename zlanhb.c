...
extern VOID zlanhb_(doublereal *__out__, char *norm, char *uplo, integer *n, integer *k, doublecomplex *ab, integer *ldab, doublereal *work);
static VALUE
rb_zlanhb(int argc, VALUE *argv, VALUE self){
  ...
  zlanhb_(&__out__, &norm, &uplo, &n, &k, ab, &ldab, work);
