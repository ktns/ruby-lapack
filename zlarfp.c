...
static VALUE
rb_zlarfp(int argc, VALUE *argv, VALUE self){
  VALUE rb_n;
  integer n; 
  VALUE rb_alpha;
  doublecomplex alpha; 
...
void
init_lapack_zlarfp(VALUE mLapack){
  rb_define_module_function(mLapack, "zlarfp", rb_zlarfp, -1);
}
