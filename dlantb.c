...
extern VOID dlantb_(doublereal *__out__, char *norm, char *uplo, char *diag, integer *n, integer *k, doublereal *ab, integer *ldab, doublereal *work);
static VALUE
rb_dlantb(int argc, VALUE *argv, VALUE self){
  ...
  dlantb_(&__out__, &norm, &uplo, &diag, &n, &k, ab, &ldab, work);
