...
extern VOID cla_herpvgrw_(real *__out__, char *uplo, integer *n, integer *info, complex *a, integer *lda, complex *af, integer *ldaf, integer *ipiv, complex *work);
static VALUE
rb_cla_herpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  cla_herpvgrw_(&__out__, &uplo, &n, &info, a, &lda, af, &ldaf, ipiv, work);
