...
extern VOID cla_gbrcond_c_(real *__out__, char *trans, integer *n, integer *kl, integer *ku, complex *ab, integer *ldab, complex *afb, integer *ldafb, integer *ipiv, real *c, logical *capply, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_gbrcond_c(int argc, VALUE *argv, VALUE self){
  ...
  cla_gbrcond_c_(&__out__, &trans, &n, &kl, &ku, ab, &ldab, afb, &ldafb, ipiv, c, &capply, &info, work, rwork);
