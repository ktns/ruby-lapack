...
extern VOID zla_syrcond_x_(doublereal *__out__, char *uplo, integer *n, doublecomplex *a, integer *lda, doublecomplex *af, integer *ldaf, integer *ipiv, doublecomplex *x, integer *info, doublecomplex *work, doublereal *rwork);
static VALUE
rb_zla_syrcond_x(int argc, VALUE *argv, VALUE self){
  ...
  zla_syrcond_x_(&__out__, &uplo, &n, a, &lda, af, &ldaf, ipiv, x, &info, work, rwork);
