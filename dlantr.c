...
extern VOID dlantr_(doublereal *__out__, char *norm, char *uplo, char *diag, integer *m, integer *n, doublereal *a, integer *lda, doublereal *work);
static VALUE
rb_dlantr(int argc, VALUE *argv, VALUE self){
  ...
  dlantr_(&__out__, &norm, &uplo, &diag, &m, &n, a, &lda, work);
