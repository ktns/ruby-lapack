...
extern VOID zlantp_(doublereal *__out__, char *norm, char *uplo, char *diag, integer *n, doublecomplex *ap, doublereal *work);
static VALUE
rb_zlantp(int argc, VALUE *argv, VALUE self){
  ...
  zlantp_(&__out__, &norm, &uplo, &diag, &n, ap, work);
