...
static VALUE
rb_dlarfp(int argc, VALUE *argv, VALUE self){
  VALUE rb_n;
  integer n; 
  VALUE rb_alpha;
  doublereal alpha; 
...
void
init_lapack_dlarfp(VALUE mLapack){
  rb_define_module_function(mLapack, "dlarfp", rb_dlarfp, -1);
}
