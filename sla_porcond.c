...
extern VOID sla_porcond_(real *__out__, char *uplo, integer *n, real *a, integer *lda, real *af, integer *ldaf, integer *cmode, real *c, integer *info, real *work, integer *iwork);
static VALUE
rb_sla_porcond(int argc, VALUE *argv, VALUE self){
  ...
  sla_porcond_(&__out__, &uplo, &n, a, &lda, af, &ldaf, &cmode, c, &info, work, iwork);
