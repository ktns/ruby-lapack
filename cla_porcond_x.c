...
extern VOID cla_porcond_x_(real *__out__, char *uplo, integer *n, complex *a, integer *lda, complex *af, integer *ldaf, complex *x, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_porcond_x(int argc, VALUE *argv, VALUE self){
  ...
  cla_porcond_x_(&__out__, &uplo, &n, a, &lda, af, &ldaf, x, &info, work, rwork);
