...
extern VOID cla_porpvgrw_(real *__out__, char *uplo, integer *ncols, complex *a, integer *lda, complex *af, integer *ldaf, complex *work);
static VALUE
rb_cla_porpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  cla_porpvgrw_(&__out__, &uplo, &ncols, a, &lda, af, &ldaf, work);
