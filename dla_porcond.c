...
extern VOID dla_porcond_(doublereal *__out__, char *uplo, integer *n, real *a, integer *lda, doublereal *af, integer *ldaf, integer *cmode, doublereal *c, integer *info, doublereal *work, integer *iwork);
static VALUE
rb_dla_porcond(int argc, VALUE *argv, VALUE self){
  ...
  dla_porcond_(&__out__, &uplo, &n, a, &lda, af, &ldaf, &cmode, c, &info, work, iwork);
