...
extern VOID zla_syrpvgrw_(doublereal *__out__, char *uplo, integer *n, integer *info, doublecomplex *a, integer *lda, doublecomplex *af, integer *ldaf, integer *ipiv, doublecomplex *work);
static VALUE
rb_zla_syrpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  zla_syrpvgrw_(&__out__, &uplo, &n, &info, a, &lda, af, &ldaf, ipiv, work);
