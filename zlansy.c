...
extern VOID zlansy_(doublereal *__out__, char *norm, char *uplo, integer *n, doublecomplex *a, integer *lda, doublereal *work);
static VALUE
rb_zlansy(int argc, VALUE *argv, VALUE self){
  ...
  zlansy_(&__out__, &norm, &uplo, &n, a, &lda, work);
