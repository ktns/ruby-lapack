...
extern VOID cla_syrcond_c_(real *__out__, char *uplo, integer *n, complex *a, integer *lda, complex *af, integer *ldaf, integer *ipiv, real *c, logical *capply, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_syrcond_c(int argc, VALUE *argv, VALUE self){
  ...
  cla_syrcond_c_(&__out__, &uplo, &n, a, &lda, af, &ldaf, ipiv, c, &capply, &info, work, rwork);
