...
static VALUE
rb_clarfp(int argc, VALUE *argv, VALUE self){
  VALUE rb_n;
  integer n; 
  VALUE rb_alpha;
  complex alpha; 
...
void
init_lapack_clarfp(VALUE mLapack){
  rb_define_module_function(mLapack, "clarfp", rb_clarfp, -1);
}
