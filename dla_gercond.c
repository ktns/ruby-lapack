...
extern VOID dla_gercond_(doublereal *__out__, char *trans, integer *n, doublereal *a, integer *lda, doublereal *af, integer *ldaf, integer *ipiv, integer *cmode, doublereal *c, integer *info, doublereal *work, integer *iwork);
static VALUE
rb_dla_gercond(int argc, VALUE *argv, VALUE self){
  ...
  dla_gercond_(&__out__, &trans, &n, a, &lda, af, &ldaf, ipiv, &cmode, c, &info, work, iwork);
