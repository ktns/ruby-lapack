...
extern VOID zla_rpvgrw_(doublereal *__out__, integer *n, integer *ncols, doublereal *a, integer *lda, doublereal *af, integer *ldaf);
static VALUE
rb_zla_rpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  zla_rpvgrw_(&__out__, &n, &ncols, a, &lda, af, &ldaf);
