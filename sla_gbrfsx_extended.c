...
rblapack_sla_gbrfsx_extended(int argc, VALUE *argv, VALUE self){
  ...
  rblapack_ab = argv[4];
  rblapack_afb = argv[5];
  rblapack_ldafb = argv[6];
  rblapack_ipiv = argv[7];
  rblapack_colequ = argv[8];
  rblapack_c = argv[9];
  rblapack_b = argv[10];
  rblapack_y = argv[11];
  ...
  if (NA_SHAPE0(rblapack_afb) != ldab)
