...
extern VOID sla_gbrcond_(real *__out__, char *trans, integer *n, integer *kl, integer *ku, real *ab, integer *ldab, real *afb, integer *ldafb, integer *ipiv, integer *cmode, real *c, integer *info, real *work, integer *iwork);
static VALUE
rb_sla_gbrcond(int argc, VALUE *argv, VALUE self){
  ...
  sla_gbrcond_(&__out__, &trans, &n, &kl, &ku, ab, &ldab, afb, &ldafb, ipiv, &cmode, c, &info, work, iwork);
