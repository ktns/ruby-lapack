...
extern VOID cla_hercond_x_(real *__out__, char *uplo, integer *n, complex *a, integer *lda, complex *af, integer *ldaf, integer *ipiv, complex *x, integer *info, complex *work, real *rwork);
static VALUE
rb_cla_hercond_x(int argc, VALUE *argv, VALUE self){
  ...
  cla_hercond_x_(&__out__, &uplo, &n, a, &lda, af, &ldaf, ipiv, x, &info, work, rwork);
