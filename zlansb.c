...
extern VOID zlansb_(doublereal *__out__, char *norm, char *uplo, integer *n, integer *k, doublecomplex *ab, integer *ldab, doublereal *work);
static VALUE
rb_zlansb(int argc, VALUE *argv, VALUE self){
  ...
  zlansb_(&__out__, &norm, &uplo, &n, &k, ab, &ldab, work);
