...
extern VOID zla_porcond_x_(doublereal *__out__, char *uplo, integer *n, doublecomplex *a, integer *lda, doublecomplex *af, integer *ldaf, doublecomplex *x, integer *info, doublecomplex *work, doublereal *rwork);
static VALUE
rb_zla_porcond_x(int argc, VALUE *argv, VALUE self){
  ...
  zla_porcond_x_(&__out__, &uplo, &n, a, &lda, af, &ldaf, x, &info, work, rwork);
