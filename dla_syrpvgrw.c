...
extern VOID dla_syrpvgrw_(doublereal *__out__, char *uplo, integer *n, integer *info, doublereal *a, integer *lda, doublereal *af, integer *ldaf, integer *ipiv, doublereal *work);
static VALUE
rb_dla_syrpvgrw(int argc, VALUE *argv, VALUE self){
  ...
  dla_syrpvgrw_(&__out__, &uplo, &n, &info, a, &lda, af, &ldaf, ipiv, work);
