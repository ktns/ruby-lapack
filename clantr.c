...
extern VOID clantr_(real *__out__, char *norm, char *uplo, char *diag, integer *m, integer *n, complex *a, integer *lda, real *work);
static VALUE
rb_clantr(int argc, VALUE *argv, VALUE self){
  ...
  clantr_(&__out__, &norm, &uplo, &diag, &m, &n, a, &lda, work);
