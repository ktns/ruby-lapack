...
rb_csysvxx(int argc, VALUE *argv, VALUE self){
  ...
  if (NA_RANK(rb_params) != 0)
    rb_raise(rb_eArgError, "rank of params (10th argument) must be %d", 0);
